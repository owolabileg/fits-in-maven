package codegen.re.parameterized;

import java.util.ArrayList;

import codegen.re.parameterized.RegExpSpec.Matching;
import codegen.re.parameterized.structure.Any;
import codegen.re.parameterized.structure.Choice;
import codegen.re.parameterized.structure.EmptyTrace;
import codegen.re.parameterized.structure.MatchEvent;
import codegen.re.parameterized.structure.MatchEventComplement;
import codegen.re.parameterized.structure.Nothing;
import codegen.re.parameterized.structure.RegExp;
import codegen.re.parameterized.structure.Repetition;
import codegen.re.parameterized.structure.SequentialComposition;
